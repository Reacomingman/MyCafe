...
namespace MyCafe_v1._5.Controllers
{
    ...
    public class OrdersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,EmployeeId,CreateTime,ProcessTime")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,EmployeeId,CreateTime,ProcessTime")] Order order)
        {
            if (ModelState.IsValid)
            {
